    ...
    <li></li>
     ...
     <?php
								...
								while ($line = mysql_fetch_assoc($distinctClassResult)){
									...
									echo '<h2 class="h2">Standard - '.$currentClass.'</h2>';
									echo '<table cellpadding=5 cellspacing=0 style="color:rgb(19,77,91); font-size: 14px; float:center; margin-left:0px; width:750px">';
									echo '<tr><td width="10%">&nbsp;</td>';
									echo '<td align="center" style="background-color: rgb(19,77,91); border-right: 1px solid white; color:white;" width="30%">Course ID</td>';
									echo '<td align="center" style="background-color: rgb(19,77,91); border-left: 1px solid white; color:white" width="50%">Course Description</td>';
